...
namespace BankMekllat.view
{
    public partial class EditCustomer : Form
    {
        ...
        {
            txt_national.Text = nationalCode;
            ...
            if (gender)
            {
                combo_gender.SelectedText = "Male";
            }
            else combo_gender.SelectedText = "Female";
        ...
        private void btn_submit_Click(object sender, System.EventArgs e)
        {
            ...
            CustomerDetails customerDetails = new CustomerDetails(txt_national.Text, txt_zipcode.Text, txt_fname.Text, txt_lname.Text,
